...
Enter the following for the Git repo for the application - https://github.com/utherp0/forumstaticassets[https://github.com/utherp0/forumstaticassets]
...
Enter the following for the Git repo for the application - https://github.com/utherp0/ocpnode[https://github.com/utherp0/ocpnode]
...
Click on 'Workloads' and then select Pods to see the list of pods for the project as shown in the image below.
