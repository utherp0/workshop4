...
Before we can create an integration, we need to add a Camel K 'IntegrationPlatform'. Again, if you have done the Eventing Lab this will be active already.
...
Make sure you have chosen the project 'knative-userX' where X is your assigned user number
