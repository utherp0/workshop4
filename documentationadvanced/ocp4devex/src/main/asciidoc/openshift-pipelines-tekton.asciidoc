...
TIP: As part of the pre-requisites you should have cloned the required git repo - if you haven't please go back to the pre-requisites and execute the command listed at the end
