...
Click on 'Topology / Project Details' - The activity pane on the far right will show you whats going on. It will look similar to the one below (please be patient)
...
NOTE: For the next exercise, you will need 2 terminal windows. Copy the URL for the “browser terminal” and paste into a new browser tab

*In the first tab, you will notice that the terminal window is outputting the log - useful!* 

In the new terminal, make sure you go back to the 'workspace' directory.
