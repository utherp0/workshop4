...
Finally, for use in the examples we will require some source material from the git repo for this workshop. To check that this is already provided type the following in the terminal:

[source]
----
cd /workspace/workshop4
ls -alR
----
