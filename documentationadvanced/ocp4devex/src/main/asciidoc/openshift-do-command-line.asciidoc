...
This should result in your user name being displayed followed by the advterminal project being shown by the result to the odo command
...
Enter the follow command in the terminal, replacing x with your unique user number
...
Ensure you are working in the odox project

==== Download source assets

The pipeline assets are located in a GIT repository. Using your terminal window download the assets using the commands below
