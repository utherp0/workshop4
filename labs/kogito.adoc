...
[source]
----
for i in {1..50} ; do curl -X POST "http://kogito-quickstart-kogito-{{USER_ID}}{{ROUTE_URL}}/getting_started" -H "accept: application/json" -H "Content-Type: application/json" -d "{}" ; sleep .05 ; done
----
...
[source]
----
curl -X POST "http://airmiles-service-kogito-airmiles-{{USER_ID}}{{ROUTE_URL}}/airmiles" -H 'Accept: application/json' -H 'Content-Type: application/json' -d '{ "Status": "GOLD",    "Price": 600}'
----
...
[source]
----
for i in {1..50} ; do curl -X POST "http://airmiles-service-kogito-airmiles-{{USER_ID}}{{ROUTE_URL}}/airmiles" -H "accept: application/json" -H "Content-Type: application/json"  -d '{ "Status": "GOLD",    "Price": 600}'; sleep .05 ; done
----
