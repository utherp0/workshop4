...
Select the quay-workshop-userXX organization and you should see the details of the organization as shown below.
...
Switch to the Quay web user interface. Select the 'tags' view (2nd option down on the repository menu). This will show the tags view similar to that which is shown below.
