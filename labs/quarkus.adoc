...
You will now create a Quarkus workspace for you to use. Select the `Custom Workspace` tab.
...
That's it. Your workspace configuration is complete. Hit the `Load devfile` button.
